...
GRIPLOCK isn't just security. It's access.
...
<CardGroup cols={2}>
  ...
  <Card title="Top Up Instantly" icon="wallet">
    Fund your virtual card directly from your wallet. Instant balance updates. No waiting.
  </Card>
